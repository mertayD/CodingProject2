...
data.list <- list(
  ...
  prostate=list(
    label.vec=ifelse(ElemStatLearn::prostate$lpsa =="lpsa", 1, 0),
    feature.mat=as.matrix(ElemStatLearn::prostate[, 1:ncol(ElemStatLearn::prostate)-3])),
  ozone=list(
    # label.vec=ifelse(ElemStatLearn::ozone$ozone=="ozone", 1, 0),
...
for(data.name in names(data.list))
{
  ...
  {  
   # print(data.name)
    ...
    #result <- LMSquareLossEarlyStoppingCV( X.mat,
     #                                      y.vec,
      #                                     fold.vec,
       #                                    max.iterations)
  #  print("Result:  ")
  ...
  #result <- codingProject2::LMSquareLossEarlyStoppingCV( X.mat,
  #                                          y.vec,
   #                                          fold.vec,
   #                                          max.iterations)
